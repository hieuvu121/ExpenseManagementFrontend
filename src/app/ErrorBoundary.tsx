    ...
    return (
      <div className="grid min-h-screen place-items-center px-4 py-10">
        <div className="w-full max-w-[440px] rounded-md border border-dashed border-line bg-card p-6 text-center">
          <b className="mb-1 block text-[17px] text-ink">Something went wrong</b>
          <p className="text-[13.5px] text-ink-soft">
            The page couldn't be drawn. Reloading usually clears it.
          </p>
          <pre className="mt-3 max-h-32 overflow-auto rounded border border-line-soft bg-paper p-2 text-left font-mono text-[11px] text-ink-soft">
            {error.message}
          </pre>
